...
class InceptionI3d(nn.Module):
    ...
    def preprocess(self, videos, target_resolution):
        ...
        all_frames = rearrange(videos, "b t h w c -> (b t) c h w")
        resized_videos = F.interpolate(all_frames.float(), size=target_resolution, mode='bilinear', align_corners=False)
        output_videos = rearrange(resized_videos, "(b t) c h w -> b c t h w", b=b) # (b, c, t, *)
