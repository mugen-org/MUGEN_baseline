...
--audio_vqvae vqvae_coinrun_128x_full_mix \
...
--default_root_dir output/AudioVideoGPT_L32_128x --use_manual_annotation --get_audio --get_game_frame --loss_video_weight 7