...
# ------------------------------------------------------------------------------
python generation/train_gpt.py --input_modality audio --output_modality video \
--video_vqvae checkpoints/generation/video_vqvae/L32/epoch=54-step=599999.ckpt \
--audio_vqvae vqvae_coinrun_256x_full_mix \
...
--default_root_dir output/AudioVideoGPT_L32_256x --use_manual_annotation --get_audio --get_game_frame --loss_video_weight 7